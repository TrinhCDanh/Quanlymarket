    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Danh sách sạp
                <small>
                    <a href="{{ route('admin.sap.create') }}" class="btn btn-primary">Thêm mới</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><b > Bấm vào</b>
                                            <a href="{{ url('/excel/import_sap.xlsx') }}" class="text-red">đây</a>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Danh sách sạp</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- .box-body -->
                            <form action="{{route('admin.sap.list')}}" method="GET">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4">
                                                    <select name="searchOption" class="form-control">
                                                        ...
                                                        <option value="2" <?php if(isset($_GET['searchOption']) && $_GET['searchOption'] == 2) echo 'selected'; ?>>Mã quầy/sạp</option>
                                                        <option value="3" <?php if(isset($_GET['searchOption']) && $_GET['searchOption'] == 3) echo 'selected'; ?>>Tên quầy/sạp</option>
                                                        <option value="4" <?php if(isset($_GET['searchOption']) && $_GET['searchOption'] == 4) echo 'selected'; ?>>Tên hộ kinh doanh</option>
                                                    </select>
                                                </div>
                                                <div class="col-xs-4 text-center">
                                                    <button class="btn btn-primary">Tìm Kiếm</button>
                                                    <a href="{{ route('admin.sap.list') }}" class="btn btn-danger">Làm mới</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <select class="form-control select" name="id_cho">
                                                        <option value="" selected>-- Chọn chợ --</option>
                                                        @foreach($cho as $item)
                                                        <option {{ isset($_GET['id_cho'])&& $_GET['id_cho'] == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->ten }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-xs-4">
                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Quản lý sạp </h3>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="2">Tên quầy/sạp</th>
                                            <th rowspan="2">Tên hộ kinh doanh</th>
                                            <th rowspan="2">Chợ</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.sap.show', $item->id) }}" class="btn btn-xs btn-info">Xem </a>
                                                <a href="{{ route('admin.sap.edit', $item->id) }}" class="btn btn-xs btn-success">Sửa</a>
                                                <a onclick="return confirm('Bạn có muốn xóa không?') ;" href="{{ route('admin.sap.destroy', $item->id) }}" class="btn btn-xs btn-danger">Xóa </a>
                                            </td>
                                            <td>{{ $start_order++ }}</td>
                                            <td>{{ $item->ma_so_sap }}</td>
                                            <td>{{ $item->ten }}</td>
                                            <td>{{ isset($item->hoKinhDoanh['ten_ho_kd']) ? $item->hoKinhDoanh['ten_ho_kd'] : '-' }}</td>
                                            <td>{{ isset($item->cho['ten']) ? $item->cho['ten'] : '-' }}</td>
                                        </tr>
                                            @endforeach
                                        @else
                                        <tr>
