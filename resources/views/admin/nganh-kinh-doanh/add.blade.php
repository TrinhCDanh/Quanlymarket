...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Thêm ngành kinh doanh</li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action="{{ route('admin.nganh_kinh_doanh.store') }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input name="ten_nganh" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
